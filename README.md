# VFS_algeria_appointment_scripts
...
- It's really hard to get an appointment at VFS centers these days, especially for Algeria 🇩🇿.  
...
2. Select a script in this repo that you wish to use (for VFS Algeria).  
